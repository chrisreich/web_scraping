...
if [ -s "/Users/creich/practice/mmm/massey_peabody/nfl_flag.txt" ];
then
  echo "nfl already done"
else
  echo "running NFL"
  cd /Users/creich/practice/mmm/massey_peabody/
  /usr/local/bin/scrapy crawl NFL_mp
  python nfl_send_message.py
fi


if [ -s "/Users/creich/practice/mmm/massey_peabody/cfb_flag.txt" ];
then
